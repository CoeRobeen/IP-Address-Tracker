...
const locationinfo = document.querySelector('.localizacao-valor');
const timeZone = document.querySelector('.horario-valor');
const isp = document.querySelector('.isp-valor');
const ipInput = document.querySelector('.ip-input');
const goButton = document.querySelector('.btn-pesquisa');
...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1IjoiY29lcm9iZWVuIiwiYSI6ImNrczgwbGs2ajB0encybmxoNzI3bzdnNnIifQ.YkBoidRzxhkCOSwzXaAuJw'
}).addTo(mymap);
